...
public:
	...
	void OnAttributeChange(const TTuple<FGameplayAttribute, FGameplayAttribute>& Pair, UT_AttributeSet* AttributeSet, float OldValue);
	...
	void SpawnDamageNumbers(float NewValue, float OldValue);
...
protected:
	...
	// 数字 Niagara 模板
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DamageNumbers")
	UNiagaraSystem* NumberSystemTemplate;
